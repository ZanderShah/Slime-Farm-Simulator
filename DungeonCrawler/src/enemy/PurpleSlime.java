...
import engine.damage.PoisonSlimeBall;
...
public class PurpleSlime extends Slime
{
	...
	public PurpleSlime(int x, int y)
	{
		super(x, y);

		setStats(new Stats(75, 100, 100, 100, 10.0));
	...
	public void update(Room l)
	{
		...
		else
		{
			...
			if (movementCounter == 30)
			{
				...
				l.addDamageSource(
						new PoisonSlimeBall(getPos(), EnemyAttackPatterns
								.runTowardsPlayer(l, getPos()), false, getID()),
						1);
			}
			if (movementCounter < 30)
			{
	...
	public void draw(Graphics g, Vector2D offset)
	{
		...
		g.drawImage(SpriteSheet.ENEMIES[4], (int) shifted.getX()
