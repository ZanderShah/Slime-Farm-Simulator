...
public class PoisonArrow extends Projectile {
	...
	public PoisonArrow(Vector2D pos, Vector2D dir, boolean player, long id) {
		super(new AABB(pos, 3, 3), 0, -1, pos, dir.getNormalized().multiply(Constants.ARROW_SPEED), true, player,
				Constants.POISON_ARROW_DAMAGE, new StatusEffect(1200, 40, -5, StatusEffect.HEALTH, false),
