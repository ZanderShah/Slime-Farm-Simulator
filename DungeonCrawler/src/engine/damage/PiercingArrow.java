...
public class PiercingArrow extends Projectile
{
	...
	{
		super(new AABB(pos, SpriteSheet.PROJECTILES[6].getWidth(null),
				SpriteSheet.PROJECTILES[6].getHeight(null)), 5, -1, pos, dir
				.getNormalized().multiply(Constants.ARROW_SPEED), false,
				player, Constants.PIERCING_ARROW_DAMAGE, 0, id);
	}
