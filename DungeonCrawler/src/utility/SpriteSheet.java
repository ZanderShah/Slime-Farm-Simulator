...
{
	public static Image[] FLOORS, DECORATIVE_IMAGES, BLOCKING_IMAGES, MAGE_IMAGES, HUNTER_IMAGES, CLERIC_IMAGES, DOORS, WALLS, PROJECTILES;
	...
	public static void initializeImages()
	{
		try
		{
			...
			for (int i = 1; i <= 4; i++) {
				...
				THIEF_IMAGES[i-1][0] = ImageIO.read(new File("img//Thief" + i + ".png"));
			}
			
			for (int i = 1; i <= 4; i++) {
				THIEF_IMAGES[i-1][1] = ImageIO.read(new File("img//ThiefQ" + i + ".png"));
			}
			...
			PROJECTILES[4] = ImageIO.read(new File("img//Arrow1.png"));
			PROJECTILES[5] = ImageIO.read(new File("img//Arrow2.png"));
