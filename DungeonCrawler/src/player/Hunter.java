...
public class Hunter extends Player
{
	...
	{
		super(4);
		setStats(new Stats(Constants.HUNTER_HEALTH,
				Constants.HUNTER_ATTACK_SPEED, Constants.HUNTER_ATTACK_LENGTH,
	...
	public void draw(Graphics g, Vector2D offset)
	{
		...
		g.drawImage(SpriteSheet.HUNTER_IMAGES[getDirection()],
	...
	{
		return SpriteSheet.HUNTER_IMAGES[getDirection()].getHeight(null);
	}
			...
			if (attacked)
			{
				if (getAbilityActive(1) != 0)
				{
					r.addDamageSource(new PoisonArrow(getPos().add(
							getAttackDir().multiply(30)), getAttackDir(), true));
	...
	public void ability3(Point p, Room r)
	{
		if (getAbilityActive(3) == 0 && getCooldown(3) == 0)
		{
			...
			giveStatusEffect(new StatusEffect(240, 0, 0.6, StatusEffect.SPEED,
					true));
		}
	}
}
