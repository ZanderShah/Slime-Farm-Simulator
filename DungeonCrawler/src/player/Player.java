...
public abstract class Player extends LivingEntity
{
	...
	{
		experience = Math.min(experience + exp,
				Constants.EXPERIENCE_REQUIRED[level]);

		if (experience >= Constants.EXPERIENCE_REQUIRED[level]
				&& level + 1 < Constants.EXPERIENCE_REQUIRED.length)
		{
			experience = 0;
			level++;
